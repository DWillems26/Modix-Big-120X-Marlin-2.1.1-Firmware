...
void _goto_menu_move_distance_e2(); //Willie's Edit
void _menu_move_distance_e2_maybe(); //Willie's Edit
...
void menu_move() {
  ...
  //else
    //GCODES_ITEM(MSG_AUTO_HOME, FPSTR(G28_STR)); //Willie's Edits
    ...
    //SUBMENU(MSG_MOVE_E, _menu_move_distance_e_maybe); //Willie's Edit - to remove redundant "Extruder" from move axis
...
void menu_motion() {
  ...
  // Willie's Edit - to remove UBL from motion menu and add it to Modix Calibration Menu
  // Level Bed
  //
  //#if ENABLED(AUTO_BED_LEVELING_UBL)
