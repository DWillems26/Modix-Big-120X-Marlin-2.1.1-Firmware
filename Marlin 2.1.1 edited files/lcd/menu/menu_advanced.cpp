...
//Willie's Edit - to remove temperature menu from advanced menu
...
//
//#if SHOW_MENU_ADVANCED_TEMPERATURE //Willie's Edit - to remove temperature menu from advanced menu
  ...
  void menu_advanced_temperature() {
    ...
    //#if ENABLED(MPC_AUTOTUNE_MENU) //Willie's Edit - to move MPC AutoTune to Temperature Menu
...
void menu_advanced_settings() {
  ...
  //#if SHOW_MENU_ADVANCED_TEMPERATURE //Willie's edit - to remove temperature from advanced menu
