...
namespace Language_en {
  ...
  LSTR MSG_START_PROCESS                  = _UxGT("1. Start Process"); //Willie's Edit
  LSTR MSG_ADJUST_HEIGHTZ                 = _UxGT("2. Adjust Height(Z)"); //Willie's Edit
  LSTR MSG_SAVE_SETTINGSZ                 = _UxGT("3. Save Settings"); //Willie's Edit
  LSTR MSG_CALIBRATION_LEFT               = _UxGT("3. Calibrate Left"); //Willie's Edit
  LSTR MSG_CALIBRATION_RIGHT              = _UxGT("4. Calibrate Right"); //Willie's Edit
  LSTR MSG_GOTOLEFTSCREW                  = _UxGT("Go to L.Screw"); //Willie's Edit
  LSTR MSG_GOTOLEFTREARSCREW              = _UxGT("1.Go to Rear L.Screw"); //Willie's Edit
  LSTR MSG_GOTOLEFTFRONTSCREW             = _UxGT("2.Go to Front L.Screw"); //Willie's Edit
  LSTR MSG_GOTORIGHTREARSCREW             = _UxGT("1.Go to Rear R.Screw"); //Willie's Edit
  LSTR MSG_GOTORIGHTFRONTSCREW            = _UxGT("2.Go to Front R.Screw"); //Willie's Edit
  LSTR MSG_1SET_TEMP                       = _UxGT("1.Set Temerature"); //Willie's Edit
  LSTR MSG_2SETZOFFSET                    = _UxGT("2.Set Z Offset"); //Willie's Edit
  LSTR MSG_3HOMEXY                        = _UxGT("3.Home X & Y"); //Willie's Edit
  LSTR MSG_4VERIFYHEIGHT                  = _UxGT("4.Verify Height"); //Willie's Edit
  LSTR MSG_5HEATINGPLEASEWAIT             = _UxGT("Heating, Please wait!"); //Willie's Edit
  LSTR MSG_5PRINTTESTLINE                 = _UxGT("5.Print Test Line"); //Willie's Edit
  LSTR MSG_6SAVEZOFFSET                   = _UxGT("Save Z Offset"); //Willie's Edit
  LSTR MSG_CALIBRATION_120X               = _UxGT("120X Calibration");//Willie's Edit
  LSTR MSG_CALIBRATION                    = _UxGT("Big-60 Calibration"); //Willie's Edit
  LSTR MSG_GOTOFRONT                      = _UxGT("Go to the Front"); //Willie's Edit
  LSTR MSG_vALIDATE_MESH_PLA              = _UxGT("Validate Mesh (PLA)"); //Willie's Edit
  LSTR MSG_VALIDATE_MESH_PETG             = _UxGT("Validate Mesh (PETG)"); //Willie's Edit
  LSTR MSG_PLA4                           = _UxGT("PLA Nozzle:0.4"); //Willie's Edit
  LSTR MSG_PLA6                           = _UxGT("PLA Nozzle:0.6"); //Willie's Edit
  LSTR MSG_PLA8                           = _UxGT("PLA Nozzle:0.8"); //Willie's Edit
  LSTR MSG_PLA1                           = _UxGT("PLA Nozzle:1.0"); //Willie's Edit
  LSTR MSG_PETG4                          = _UxGT("PETG Nozzle:0.4"); //Willie's Edit
  LSTR MSG_PETG6                          = _UxGT("PETG Nozzle:0.6"); //Willie's Edit
  LSTR MSG_PETG8                          = _UxGT("PETG Nozzle:0.8"); //Willie's Edit
  LSTR MSG_PETG1                          = _UxGT("PETG Nozzle:1.0"); //Willie's Edit
  LSTR MSG_TILT_CALIBRATION               = _UxGT("Tilt Calibration"); //Willie's Edit
  LSTR MSG_ZOFFSET_CALIBRATION            = _UxGT("Z Offset Calibration"); //Willie's Edit
  LSTR MSG_PROBE_CALIBRATION              = _UxGT("Probe Calibration"); //Willie's Edit
  ...
  LSTR MSG_UBL_3POINT_MESH_LEVELING       = _UxGT("4-Point Leveling"); //Willie's Edits - changed to 4-point bed leveling
  ...
  LSTR MSG_UBL_7_SAVE_MESH                = _UxGT("5. Save Bed Mesh"); //Willie's Edit - Originally numbered "7."
